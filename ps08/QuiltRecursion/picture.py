"""Python code for Henderson-like picture language abstraction built on top 
   ...
   Lyn Turbak, Sep 2015, with edits by Sravana Reddy, Oct 2015."""
...
"""-------------------------------------------------------------------------
Nest a picture in the upper right quadrant of another picture
-------------------------------------------------------------------------"""

def upperRightNest(pic1, pic2):
    """Returns a new picture in which pic2 is overlayed on
